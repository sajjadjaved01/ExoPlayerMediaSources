...
class ClippingMediaSourceActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_clipping_media_source)
    ...
    private fun initializePlayer() {
       ...
       //  providing samples, in microseconds.
        val clippingMediaSource = ClippingMediaSource(mediaSource, 1000000, 4000000)
...
/*        val mediaSource = ExtractorMediaSource.Factory(mediaDataSourceFactory)
        ...
        with(player) {
            prepare(clippingMediaSource, false, false)
            playWhenReady = true
        }
